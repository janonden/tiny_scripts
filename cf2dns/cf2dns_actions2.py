...
OPTIMIZATION_IP = os.environ["OPTIMIZATION_IP"]
...
def get_optimization_ip():
    try:
        ...
        srv_session.mount('https://', HostHeaderSSLAdapter())
        response = srv_session.post(OPTIMIZATION_IP,
                                 json={"type": "v4" if RECORD_TYPE == "A" else "v6"},
